/**
 * Water Level Sensor Driver - Implementation
 */
...
static adc1_channel_t s_adc_channel = ADC_CHANNEL_4;
 ...
 */
esp_err_t water_level_init(adc1_channel_t adc_channel)
{
    ...
    s_initialized = true;
    ESP_LOGI(TAG, "Water level sensor initialized on ADC channel %d", adc_channel);
